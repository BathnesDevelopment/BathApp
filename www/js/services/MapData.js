...
.factory('MapData', function ($http, $q, DataTransformations) {
    ...
    return {
        getLayer: function (layer, lat, lng) {
            ...
            var pos = DataTransformations.LLtoNE(lat, lng);
                ...
                .success(function (data, status, headers, config) {
                    ...
                    if (layer === "CarParksLive") {
                        for (i = 0; i < data.length ; i++) {
                            ...
                            latlng = DataTransformations.NEtoLL(easting, northing);
                        ...
                        var aqMon = ["guildhall", "londonrdenc", "londonrdaurn", "royalvicpark", "windsorbridge"];
                        ...
                        for (i = 0; i < data[0].features.length ; i++) {
                            ...
                            latlng = DataTransformations.NEtoLL(northing, easting);
